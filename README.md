...
read the data using pandas and used the linear regression model from sklearn.
converted the string attributes to int. 
divided the data in two parts 10% and 90% for testing and training.
trained the model and tested it on the testing data and calculated the accuracy using the given lables.
